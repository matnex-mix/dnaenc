...
class DnaRnsPage extends StatefulWidget {
  @override
  _DnaRnsPageState createState() => _DnaRnsPageState();
}

class _DnaRnsPageState extends State<DnaRnsPage> {
                  ...
                  FlatButton(
                    ...
                    onPressed: () async {
                      ...
                      Future.delayed( Duration(seconds: 1), () async {
                        String result = await Scripts.dnaRnsEncrypt( plaintext.text );
                ...
                children: <Widget>[
                  ...
                  FlatButton(
                    ...
                    onPressed: () async {
                      ...
                      var time = new DateTime.now().millisecondsSinceEpoch;
                      Future.delayed( Duration(seconds: 1), () async {
                        String result = await Scripts.dnaRnsDecrypt( ciphertext.text );
